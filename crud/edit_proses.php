...
if (mysqli_num_rows($result) > 0) {
    ...
    $query_email = "SELECT * FROM mahasiswa WHERE email = '$email' AND id != '$id'";
    ...
    if (mysqli_num_rows($result_email) > 0) {
        ...
        $query_nomor = "SELECT * FROM mahasiswa WHERE nomor = '$nomor' AND id != '$id'";
